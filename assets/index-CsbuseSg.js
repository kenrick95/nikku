 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ee={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},se=e=>(...t)=>({_$litDirective$:e,values:t});class ie{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,r){this.t=t,this._$AM=s,this.i=r}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Ve=Symbol("Comlink.proxy"),js=Symbol("Comlink.endpoint"),Fs=Symbol("Comlink.releaseProxy"),zt=Symbol("Comlink.finalizer"),Et=Symbol("Comlink.thrown"),Ue=e=>typeof e=="object"&&e!==null||typeof e=="function",Ys={canHandle:e=>Ue(e)&&e[Ve],serialize(e){const{port1:t,port2:s}=new MessageChannel;return He(e,t),[s,[s]]},deserialize(e){return e.start(),ze(e)}},Zs={canHandle:e=>Ue(e)&&Et in e,serialize({value:e}){let t;return e instanceof Error?t={isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:t={isError:!1,value:e},[t,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}},Ie=new Map([["proxy",Ys],["throw",Zs]]);function Xs(e,t){for(const s of e)if(t===s||s==="*"||s instanceof RegExp&&s.test(t))return!0;return!1}function He(e,t=globalThis,s=["*"]){t.addEventListener("message",function r(i){if(!i||!i.data)return;if(!Xs(s,i.origin)){console.warn(`Invalid origin '${i.origin}' for comlink proxy`);return}const{id:o,type:n,path:h}=Object.assign({path:[]},i.data),a=(i.data.argumentList||[]).map(z);let c;try{const p=h.slice(0,-1).reduce((f,E)=>f[E],e),u=h.reduce((f,E)=>f[E],e);switch(n){case"GET":c=u;break;case"SET":p[h.slice(-1)[0]]=z(i.data.value),c=!0;break;case"APPLY":c=u.apply(p,a);break;case"CONSTRUCT":{const f=new u(...a);c=Js(f)}break;case"ENDPOINT":{const{port1:f,port2:E}=new MessageChannel;He(e,E),c=Ye(f,[f])}break;case"RELEASE":c=void 0;break;default:return}}catch(p){c={value:p,[Et]:0}}Promise.resolve(c).catch(p=>({value:p,[Et]:0})).then(p=>{const[u,f]=Lt(p);t.postMessage(Object.assign(Object.assign({},u),{id:o}),f),n==="RELEASE"&&(t.removeEventListener("message",r),We(t),zt in e&&typeof e[zt]=="function"&&e[zt]())}).catch(p=>{const[u,f]=Lt({value:new TypeError("Unserializable return value"),[Et]:0});t.postMessage(Object.assign(Object.assign({},u),{id:o}),f)})}),t.start&&t.start()}function qs(e){return e.constructor.name==="MessagePort"}function We(e){qs(e)&&e.close()}function ze(e,t){return Ft(e,[],t)}function wt(e){if(e)throw new Error("Proxy has been released and is not useable")}function je(e){return Q(e,{type:"RELEASE"}).then(()=>{We(e)})}const kt=new WeakMap,Mt="FinalizationRegistry"in globalThis&&new FinalizationRegistry(e=>{const t=(kt.get(e)||0)-1;kt.set(e,t),t===0&&je(e)});function Ks(e,t){const s=(kt.get(t)||0)+1;kt.set(t,s),Mt&&Mt.register(e,t,e)}function Gs(e){Mt&&Mt.unregister(e)}function Ft(e,t=[],s=function(){}){let r=!1;const i=new Proxy(s,{get(o,n){if(wt(r),n===Fs)return()=>{Gs(i),je(e),r=!0};if(n==="then"){if(t.length===0)return{then:()=>i};const h=Q(e,{type:"GET",path:t.map(a=>a.toString())}).then(z);return h.then.bind(h)}return Ft(e,[...t,n])},set(o,n,h){wt(r);const[a,c]=Lt(h);return Q(e,{type:"SET",path:[...t,n].map(p=>p.toString()),value:a},c).then(z)},apply(o,n,h){wt(r);const a=t[t.length-1];if(a===js)return Q(e,{type:"ENDPOINT"}).then(z);if(a==="bind")return Ft(e,t.slice(0,-1));const[c,p]=$e(h);return Q(e,{type:"APPLY",path:t.map(u=>u.toString()),argumentList:c},p).then(z)},construct(o,n){wt(r);const[h,a]=$e(n);return Q(e,{type:"CONSTRUCT",path:t.map(c=>c.toString()),argumentList:h},a).then(z)}});return Ks(i,e),i}function Qs(e){return Array.prototype.concat.apply([],e)}function $e(e){const t=e.map(Lt);return[t.map(s=>s[0]),Qs(t.map(s=>s[1]))]}const Fe=new WeakMap;function Ye(e,t){return Fe.set(e,t),e}function Js(e){return Object.assign(e,{[Ve]:!0})}function Lt(e){for(const[t,s]of Ie)if(s.canHandle(e)){const[r,i]=s.serialize(e);return[{type:"HANDLER",name:t,value:r},i]}return[{type:"RAW",value:e},Fe.get(e)||[]]}function z(e){switch(e.type){case"HANDLER":return Ie.get(e.name).deserialize(e.value);case"RAW":return e.value}}function Q(e,t,s){return new Promise(r=>{const i=ti();e.addEventListener("message",function o(n){!n.data||!n.data.id||n.data.id!==i||(e.removeEventListener("message",o),r(n.data))}),e.start&&e.start(),e.postMessage(Object.assign({id:i},t),s)})}function ti(){return new Array(4).fill(0).map(()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16)).join("-")}const ei=Symbol("getEndpoint"),si=e=>{const t=ze(e);return new Proxy(t,{get(s,r,i){return r===ei?e:Reflect.get(...arguments)}})};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=se(class extends ie{constructor(e){var t;if(super(e),e.type!==ee.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,i;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!((r=this.nt)!=null&&r.has(o))&&this.st.add(o);return this.render(t)}const s=e.element.classList;for(const o of this.st)o in t||(s.remove(o),this.st.delete(o));for(const o in t){const n=!!t[o];n===this.st.has(o)||(i=this.nt)!=null&&i.has(o)||(n?(s.add(o),this.st.add(o)):(s.remove(o),this.st.delete(o)))}return V}});var tt,T,et;class Ze{constructor({renderCallback:t}){w(this,tt,!1);w(this,T,null);w(this,et);d(this,T,null),d(this,et,t),this.render=this.render.bind(this)}start(){d(this,tt,!0),d(this,T,requestAnimationFrame(this.render))}stop(){l(this,T)&&cancelAnimationFrame(l(this,T)),d(this,tt,!1)}render(){l(this,et)&&l(this,et).call(this),l(this,tt)&&d(this,T,requestAnimationFrame(this.render))}}tt=new WeakMap,T=new WeakMap,et=new WeakMap;const ii="/nikku/assets/audio-source-jhypmOpT.js";var v,P,m,S,F,D,N,k,B,L,K,Yt,Xe;class ri{constructor(t){w(this,K);w(this,v);w(this,P);w(this,m);w(this,S);w(this,F);w(this,D);w(this,N);w(this,k);w(this,B);w(this,L);this.metadata=null,d(this,v,null),d(this,P,[]),d(this,m,null),d(this,S,null),d(this,F,0),d(this,D,!1),d(this,N,!0),d(this,k,!1),d(this,B,0),d(this,L,null),this.options=t,this.init()}async init(t){if(t?(this.metadata=t,d(this,v,new AudioContext({sampleRate:t.sampleRate})),l(this,v).audioWorklet&&await l(this,v).audioWorklet.addModule(ii),d(this,L,new Ze({renderCallback:$t(this,K,Xe).bind(this)}))):(this.metadata=null,d(this,v,null),d(this,L,null)),d(this,P,[!0]),this.metadata&&this.metadata.numberTracks>1){d(this,P,[]);for(let s=0;s<this.metadata.numberTracks;s++)s===0?l(this,P).push(!0):l(this,P).push(!1)}d(this,m,null),d(this,S,null),d(this,F,0),d(this,D,!0),d(this,N,!1),d(this,k,!1),d(this,B,1)}async destroy(){await this.pause(),this.init()}async start(){if(!this.metadata||!l(this,v))return;const{totalSamples:t,sampleRate:s}=this.metadata,r=t/s,i=Math.min(r,3),o=i*s;console.time("getSamples");const n=await this.options.decodeSamples(0,o);console.timeEnd("getSamples"),$t(this,K,Yt).call(this,n,0);const h=[];for(let a=i;a<r;a+=10)a+10<r?h.push({offset:a,size:10}):h.push({offset:a,size:r-a});(async()=>{for(const a of h){console.time("getSamples");const c=await this.options.decodeSamples(a.offset*s,a.size*s);console.timeEnd("getSamples"),$t(this,K,Yt).call(this,c,a.offset*s)}})()}initPlayback(t){if(!this.metadata||!l(this,v)||l(this,B)==null)return;const{loopStartSample:s,totalSamples:r,sampleRate:i,trackDescriptions:o}=this.metadata;d(this,m,new AudioWorkletNode(l(this,v),"audio-source-processor",{numberOfInputs:0,numberOfOutputs:1,outputChannelCount:[2],processorOptions:{initialSamples:t,loopStartSample:s,totalSamples:r,sampleRate:i,shouldLoop:l(this,D),trackDescriptions:o,trackStates:l(this,P)}})),l(this,m).port&&(l(this,m).port.addEventListener("message",n=>{switch(n.data.type){case"BUFFER_LOOPED":{console.log("[AudioPlayer]",n.data.type);break}case"BUFFER_ENDED":{console.log("[AudioPlayer]",n.data.type),this.pause(),d(this,N,!0);break}case"TIMESTAMP_REPLY":{d(this,F,n.data.payload.timestamp);break}}}),l(this,m).port.start()),d(this,S,l(this,v).createGain()),l(this,S).gain.value=l(this,B),l(this,m).connect(l(this,S)),l(this,S).connect(l(this,v).destination),d(this,N,!1)}async seek(t){l(this,v)&&(l(this,m)&&l(this,m).port.postMessage({type:"SEEK",payload:{playbackTimeInS:t}}),l(this,k)||await this.play())}async play(){var t;l(this,k)||!l(this,v)||(d(this,k,!0),(t=l(this,L))==null||t.start(),this.options.onPlay(),await l(this,v).resume(),l(this,N)&&this.seek(0))}async pause(){var t;!l(this,k)||!l(this,v)||(d(this,k,!1),(t=l(this,L))==null||t.stop(),this.options.onPause(),await l(this,v).suspend())}async setTrackStates(t){d(this,P,t),l(this,m)&&l(this,m).port.postMessage({type:"UPDATE_TRACK_STATES",payload:{trackStates:l(this,P)}})}async setVolume(t){d(this,B,t),l(this,S)&&(l(this,S).gain.value=t)}setLoop(t){d(this,D,t),l(this,m)&&l(this,m).port.postMessage({type:"UPDATE_SHOULD_LOOP",payload:{shouldLoop:l(this,D)}})}getCurrrentPlaybackTime(){return l(this,m)?l(this,F):0}}v=new WeakMap,P=new WeakMap,m=new WeakMap,S=new WeakMap,F=new WeakMap,D=new WeakMap,N=new WeakMap,k=new WeakMap,B=new WeakMap,L=new WeakMap,K=new WeakSet,Yt=function(t,s=0){var r;!this.metadata||!l(this,v)||(s===0?(this.initPlayback(t),(r=l(this,L))==null||r.start(),d(this,k,!0),this.options.onPlay()):l(this,m)&&l(this,m).port.postMessage({type:"ADD_SAMPLES",payload:{samples:t,offset:s}},t.map(i=>i.buffer)))},Xe=function(){l(this,m)&&l(this,m).port.postMessage({type:"TIMESTAMP_QUERY"})};var oi=Object.defineProperty,ni=Object.getOwnPropertyDescriptor,qe=e=>{throw TypeError(e)},x=(e,t,s,r)=>{for(var i=r>1?void 0:r?ni(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&oi(t,s,i),i},ai=(e,t,s)=>t.has(e)||qe("Cannot "+s),li=(e,t,s)=>t.has(e)?qe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),A=(e,t,s)=>(ai(e,t,"access private method"),s),$,ft,Ke,Ge,re,Qe,Je,ts,es,ss,is;let y=class extends C{constructor(){super(...arguments),li(this,$),this.playPauseIcon="play",this.loop="on",this.volume=1,this.muted=!1,this.progressMax=0,this.progressValue=0,this.timeDisplayMax=0,this.timeDisplayValue=0,this.tracksCount=1,this.tracksActive=[!0],this.disabled=!0,this.fileDraggingOver=!1,this.trackTitle="",this.errorMessage="",this.audioPlayer=null,this.workerInstance=si(new Worker(new URL("/nikku/assets/worker-BwaLLiky.js",import.meta.url),{})),this.timer=new Ze({renderCallback:()=>{if(!this.audioPlayer)return;const e=this.audioPlayer.getCurrrentPlaybackTime();this.progressValue=e,this.timeDisplayValue=e}})}render(){return M`
      <div
        id="error"
      ...
      <main id="main">
        ...
        <div id="controls-others">
          ...
          <controls-volume
            ...
            ?muted=${this.muted}
            volume=${this.volume}
            @mutedChange=${A(this,$,ss)}
            @volumeChange=${A(this,$,is)}
          ></controls-volume>
        </div>
      </main>
      <div
    ...
    `}firstUpdated(){window.addEventListener("dragover",e=>{e.preventDefault(),this.fileDraggingOver=!0}),window.addEventListener("dragend",e=>{this.fileDraggingOver=!1}),window.addEventListener("dragleave",e=>{this.fileDraggingOver=!1}),window.addEventListener("drop",e=>{if(e.preventDefault(),this.fileDraggingOver=!1,!e.dataTransfer||!e.dataTransfer.items||!e.dataTransfer.items[0]||e.dataTransfer.items[0].kind!=="file"){A(this,$,ft).call(this,new Error("No file read"));return}const t=e.dataTransfer.items[0].getAsFile();if(!t){A(this,$,ft).call(this,new Error("No file read"));return}rs(t).then(A(this,$,re).bind(this))})}};$=new WeakSet;ft=function(e){this.errorMessage=e.message+e.stack};Ke=function(){this.errorMessage=""};Ge=function(e){const t=e.target.files;if(!t||!t.length){A(this,$,ft).call(this,new Error("No file read"));return}const s=t[0];rs(s).then(A(this,$,re).bind(this))};re=async function({buffer:e,file:t}){var s;if(A(this,$,Ke).call(this),!(!e||!(e instanceof ArrayBuffer))){t.name&&(this.trackTitle=t.name);try{await this.workerInstance.init(Ye(e,[e]));const r=await this.workerInstance.getMetadata();if(this.audioPlayer?await this.audioPlayer.destroy():this.audioPlayer=new ri({onPlay:()=>{this.playPauseIcon="pause",this.timer.start()},onPause:()=>{this.playPauseIcon="play",this.timer.stop()},decodeSamples:async(n,h)=>await this.workerInstance.getSamples(n,h)||[]}),!r)throw new Error("metadata is undefined");await this.audioPlayer.init(r),await this.audioPlayer.start();const i=r.totalSamples/r.sampleRate,o=r.numberTracks;this.muted?this.audioPlayer.setVolume(0):this.audioPlayer.setVolume(this.volume),this.playPauseIcon="pause",this.progressMax=i,this.timeDisplayMax=i,this.tracksCount=o,this.tracksActive=new Array(o).fill(!0).map((n,h)=>h===0),this.disabled=!1,(s=this.audioPlayer)==null||s.play()}catch(r){A(this,$,ft).call(this,r)}}};Qe=function(e){var s;const t=e.detail.active;this.tracksActive=t,(s=this.audioPlayer)==null||s.setTrackStates(t)};Je=function(e){var s,r;const t=e.detail.mode;this.playPauseIcon=t,t==="play"?(s=this.audioPlayer)==null||s.pause():t==="pause"&&((r=this.audioPlayer)==null||r.play())};ts=function(e){var s;const t=e.detail.value;this.progressValue=t,this.timeDisplayValue=t,(s=this.audioPlayer)==null||s.seek(t)};es=function(e){var s,r;const t=e.detail.mode;this.loop=t,t==="on"?(s=this.audioPlayer)==null||s.setLoop(!0):t==="off"&&((r=this.audioPlayer)==null||r.setLoop(!1))};ss=function(e){var s,r;const t=e.detail.muted;this.muted=t,t?(s=this.audioPlayer)==null||s.setVolume(0):(r=this.audioPlayer)==null||r.setVolume(this.volume)};is=function(e){var s;const t=e.detail.volume;this.volume=t,this.muted=!1,(s=this.audioPlayer)==null||s.setVolume(t)};y.styles=U`
    #error {
      padding: 0.6rem;
      margin-top: 0.6rem;
...
`;var Ai=Object.defineProperty,Ci=Object.getOwnPropertyDescriptor,hs=e=>{throw TypeError(e)},Bt=(e,t,s,r)=>{for(var i=r>1?void 0:r?Ci(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Ai(t,s,i),i},ne=(e,t,s)=>t.has(e)||hs("Cannot "+s),Ae=(e,t,s)=>(ne(e,t,"read from private field"),t.get(e)),Ce=(e,t,s)=>t.has(e)?hs("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),jt=(e,t,s,r)=>(ne(e,t,"write to private field"),t.set(e,s),s),Pi=(e,t,s)=>(ne(e,t,"access private method"),s),W,qt,ds;let nt=class extends C{constructor(){super(...arguments),Ce(this,qt),this.disabled=!1,this.muted=!1,this.volume=1,Ce(this,W,!1),this._cachedVolumeBarOffsetLeft=null,this._cachedVolumeBarClientWidth=null,this.volumeBarContainer=Y(),this.volumeFill=Y(),this.volumeIndicator=Y(),this.updateVolumeFromEvent=e=>{this.refreshCachedValues();let t=0;e instanceof MouseEvent?t=e.clientX:e instanceof TouchEvent&&(t=e.touches[0].clientX);const s=Math.min(1,Math.max(0,(t-(this._cachedVolumeBarOffsetLeft??0))/(this._cachedVolumeBarClientWidth??1)));this.volume=s,this.dispatchEvent(new CustomEvent("volumeChange",{detail:{volume:s}}))},this.handleDraggingStart=e=>{this.disabled||Ae(this,W)||(jt(this,W,!0),this.updateVolumeFromEvent(e))},this.handleDraggingMove=e=>{this.disabled||!Ae(this,W)||this.updateVolumeFromEvent(e)},this.handleDraggingEnd=e=>{this.disabled||jt(this,W,!1)},this.handleWindowResize=()=>{this._cachedVolumeBarOffsetLeft=null,this._cachedVolumeBarClientWidth=null,this.refreshCachedValues()}}render(){return M`<div class="volume-container">
...
`;var ki=Object.defineProperty,Mi=Object.getOwnPropertyDescriptor,cs=e=>{throw TypeError(e)},ae=(e,t,s,r)=>{for(var i=r>1?void 0:r?Mi(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&ki(t,s,i),i},Li=(e,t,s)=>t.has(e)||cs("Cannot "+s),Oi=(e,t,s)=>t.has(e)?cs("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Ti=(e,t,s)=>(Li(e,t,"access private method"),s),Kt,us;let vt=class extends C{constructor(){super(...arguments),Oi(this,Kt),this.disabled=!1,this.mode="on"}render(){return M`<button
